  ...
  return (
    ...
    >
      ...
      <div style={{
        height: '18px',
        flexShrink: 0,
        background: 'linear-gradient(to bottom, #2e2e2e, #2a2a2a)',
        borderRadius: '6px 6px 0 0',
        boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.06)',
      }} />
      {/* Middle row: left bezel + screen + right bezel */}
      <div style={{ flex: 1, display: 'flex', minHeight: 0 }}>
        <div style={{ width: '14px', flexShrink: 0, background: '#272727' }} />
      ...
      <div style={{
        height: '48px',
        flexShrink: 0,
        background: 'linear-gradient(to bottom, #262626, #222222, #1e1e1e)',
        ...
        <div style={{
          ...
          height: '12px',
          borderRadius: '50%',
          background: 'linear-gradient(to bottom, #3c3c3c, #282828)',
